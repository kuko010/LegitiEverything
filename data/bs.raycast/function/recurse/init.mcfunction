...
execute if score #raycast.ux bs.data matches ..-1 store result storage bs:data raycast.sx int 0.0000001 run scoreboard players set #raycast.dx bs.data -10000000
execute if score #raycast.uy bs.data matches ..-1 store result storage bs:data raycast.sy int 0.0000001 run scoreboard players set #raycast.dy bs.data -10000000
execute if score #raycast.uz bs.data matches ..-1 store result storage bs:data raycast.sz int 0.0000001 run scoreboard players set #raycast.dz bs.data -10000000
