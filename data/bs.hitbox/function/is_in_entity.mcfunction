execute unless entity @s[tag=bs.hitbox.custom] run return run execute if entity @s[dy=0] positioned ~-0.99999999999999 ~-0.99999999999999 ~-0.99999999999999 if entity @s[dy=0]
